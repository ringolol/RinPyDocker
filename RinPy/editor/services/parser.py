...
if __name__ == '__main__':
    ...
    test_set = [
        ...
        ('var x=2', 2, arithmetic),
        ('x+1', 3, arithmetic),
        ('y+5', Exception('exception'), arithmetic),
        ('def k(y) { x + y }', None, arithmetic),
        ('k(3)', 5, arithmetic),
        ('3+4*(var z=3)', Exception('exception'), arithmetic),
        ...
        (
            'var x = 1; var y = integ(); var e = x - y; e @ y; var t = time(); calc(0.02, 10); plot(t, y)', 
            None, 
            (0.01, 5)
        ),
        ...
        ('avg', None, arithmetic),
        ('x', None, arithmetic),
        ('var arr = [1, 2, avg, x]', None, arithmetic),
        ('arr[0]', 1, arithmetic),
        ('arr[2](2,3)', 2.5, arithmetic),
        ('arr[3]', 1, arithmetic),
        ('var arr2 = [14, f(), f, 88]', None, arithmetic),
